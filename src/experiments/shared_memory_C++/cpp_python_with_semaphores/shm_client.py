'''
Responsible for handling and communicating the debugging information while the
user interacts withthe Python frontend
'''
...
def main():
    '''
    Main process which carries out functionality of the module
    '''
    ...
    while True:
        ...
        input_mes = input() + '\0'      # null terminator makes it easier for
                                        # C++ to read the string
